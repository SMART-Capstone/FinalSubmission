...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:$FABRIC_CA_ADMIN_PW@localhost:7054 --caname ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
...
function createOrg2() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:$FABRIC_CA_ADMIN_PW@localhost:8054 --caname ca-org2 --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrderer() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:$FABRIC_CA_ADMIN_PW@localhost:9054 --caname ca-orderer --tls.certfiles "${PWD}/organizations/fabric-ca/ordererOrg/ca-cert.pem"
  { set +x; } 2>/dev/null
